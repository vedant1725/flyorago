...
urlpatterns = [
    ...
    path('api/kyc/status/<str:user_id>/', KYCStatusView.as_view()),
    ...
    path('api/kyc/admin/list/', KYCAdminListView.as_view()),
    path('api/kyc/admin/action', KYCAdminActionView.as_view(), name='kyc_admin_action'),
    path('api/kyc/admin/action/', KYCAdminActionView.as_view()),
