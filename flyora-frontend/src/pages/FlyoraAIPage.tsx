      ...
      <main className="flex-1 min-w-0 w-full max-w-full lg:ml-[240px] pb-24 lg:pb-12 px-4 sm:px-8 pt-6 max-w-7xl mx-auto space-y-6 overflow-x-hidden flex flex-col h-screen">
        ...
        <div className="bg-white p-4 rounded-3xl border border-slate-200 shrink-0 space-y-3 shadow-sm">
          <form onSubmit={handleSubmit} className="flex items-center gap-3">
            <div
              className="flex-1 bg-slate-100/80 rounded-2xl px-5 py-3 flex items-center gap-3 focus-within:bg-slate-100 transition"
            ...
            >
              <input
                ...
                className="w-full bg-transparent text-slate-800 text-sm font-medium border-0 outline-none ring-0 shadow-none placeholder-slate-400 focus:outline-none focus:ring-0 focus:border-0"
              />
            </div>
